...
exports.handleCompleted = async function (org, stripe, cs) {
  ...
  /**
   * The code in this file has been deprecated due to a bug with insertion.
   * This functionality is now being handled by a special legacy handler in the laravel app's
